        ...
        <div>
          <div className="py-2 px-2">
            ...
            <div className="flex px-1 mt-2 mb-1">
              <div className="mr-1">
                <HiOutlineLocationMarker className="font-Poppins  text-yellow" />
              </div>
          ...
          <div className=" px-3 mb-3">
            <div className="flex items-center ">
              <div>
                <HiIdentification className="text-medium text-yellow mr-1" />
              </div>
              <p className="text-[14px] text-black">{name}</p>
            </div>
          </div>
          <div className="flex items-end px-4 pb-3 mb-4">
            <div className=" bg-yellow text-white font-bold text-xs px-4 py-2 rounded-lg shadow-lg">
              {(isAuthenticated &&
