          ...
          <div className="lg:px-21">
            ...
            <div className="flex justify-center">
              <div className="mb-10 md:mb-5 lg:mb-10">
                <h2 className="font-Poppins text-yellow text-lg text-center mt-10 lg:mt-5  font-semibold ">
                  {current.name}
                </h2>
            ...
            <div className="flex items-center justify-center">
              {Object.keys(data).map((index) => (
                <span
                  ...
                  onClick={handleClick}
                  className={`py-1 w-10 rounded mx-1 cursor-pointer  ${active === index ? "bg-yellow" : "bg-[#d4d4d4] "
                    }`}
                />
              ))}

              {/* <span id="p2" className="bg-yellow py-1 w-10 rounded mx-1" />
              <span id="p3" className="bg-yellow py-1 w-10 rounded mx-1" />
              <span id="p4" className="bg-yellow py-1 w-10 rounded mx-1" /> */}
            </div>
          </div>
        </div>
      </div>
