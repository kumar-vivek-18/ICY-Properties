...
const HeroForm = () => {
  ...
  return (
    <div className=" mx-auto w-11/12 md:w-9/12 lg:w-6/12 mt-20 rounded-lg bg-silverLite shadow-md p-6 px-4 ">
      <h1 className="mb-3 pl-4 md:pl-0 text-yellow font-Poppins font-medium tracking-wider text-base md:text-lg">
      ...
      <div className=" flex items-center justify-center my-2 ">
        <form onSubmit={handleSearch} className="flex  items-center w-full">
          ...
          <input
            ...
            type="text"
            className="p-3 px-4 outline-none rounded-l-lg w-full  border-2 border-yellow border-r-0 bg-silver"
            ref={phraseInputRef}
          />
          <button className="bg-yellow p-4 rounded-r-lg border-2 border-yellow ">
