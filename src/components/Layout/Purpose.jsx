  ...
  const purposeData = [
    {
      ...
      icon: <HiOutlineHome />,
      title: "Buy A Home",
      description: "Your dream home is just a search away—start exploring today.",
    },
    {
      id: "p2",
      icon: <FiKey />,
      title: "Rent A Home",
      description: "Browse verified rental properties with flexible lease options.",
    },
    {
      id: "p3",
      icon: <FaHandshake />,
      title: "Sell A Home",
      description: "Sell your home quickly and securely with ICY Properties.",
    },
  ];
      ...
      <section className="mx-auto bg-silverLite dark:bg-darkBg px-10 md:px-16 lg:px-20 py-20 pt-20 md:py-16">
        <div className="px-auto lg:px-32">
          <h1 className="font-Poppins font-bold text-3xl text-center mb-4 dark:text-ash">
            Our Main <span className="text-yellow">Focus</span>
          </h1>
          <p className="text-center text-ash">
            Explore top-rated properties chosen by our users.
          </p>
        </div>
