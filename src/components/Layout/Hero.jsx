    ...
    <section className="mt-16 w-full bg-silver dark:bg-darkBg h-auto pb-10 lg:pt-6">
      <div className="lg:flex lg:justify-between px-10">
        <div className="lg:px-16 pt-20 lg:pr-0 lg:w-1/2">
          ...
          <h1 className="text-5xl mb-4 text-yellow font-semibold tracking-widest font-Poppins">
            New Home
          </h1>
          <p className="font-Poppins text-ash mb-6">
            Discover, rent, or buy – effortlessly with ICY Properties.
          </p>
          <div className="flex items-center mb-10">
            <button className=" bg-yellow text-white font-bold text-xs p-3 px-7 rounded-lg mr-6 shadow-lg">
              Learn More
            </button>
            <button className=" bg-yellow text-white font-bold text-xs p-3  rounded-full shadow-lg">
